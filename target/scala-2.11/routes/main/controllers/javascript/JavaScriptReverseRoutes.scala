...
package controllers.javascript {
  ...
  class ReverseUserController(_prefix: => String) {
    ...
    def loginForm: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.UserController.loginForm",
      """
        function() {
    ...
    def registerForm: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.UserController.registerForm",
      """
        function() {
    ...
    // @LINE:7
    def characters: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.UserController.characters",
      """
        function() {
